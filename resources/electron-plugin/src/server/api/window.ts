...
import { notifyPhp, goToUrl, appendWindowIdToUrl } from '../utils.js';
...
router.post('/open', (req, res) => {
    ...
    window.on('blur', () => {
        notifyPhp('events', {
            event: 'Native\\Nette\\Events\\Windows\\WindowBlurred',
            payload: [id]
        });
    });
    ...
    window.on('focus', () => {
        notifyPhp('events', {
            event: 'Native\\Nette\\Events\\Windows\\WindowFocused',
            payload: [id]
        });
    });
    ...
    window.on('minimize', () => {
        notifyPhp('events', {
            event: 'Native\\Nette\\Events\\Windows\\WindowMinimized',
            payload: [id]
        });
    });
    ...
    window.on('maximize', () => {
        notifyPhp('events', {
            event: 'Native\\Nette\\Events\\Windows\\WindowMaximized',
            payload: [id]
        });
    });
    ...
    window.on('show', () => {
        notifyPhp('events', {
            event: 'Native\\Nette\\Events\\Windows\\WindowShown',
            payload: [id]
        });
    });
    ...
    window.on('resized', () => {
        notifyPhp('events', {
            event: 'Native\\Nette\\Events\\Windows\\WindowResized',
    ...
    window.on('close', (evt) => {
        ...
        notifyPhp('events', {
            event: 'Native\\Nette\\Events\\Windows\\WindowClosed',
            payload: [id]
        });
    });
    ...
    window.on('hide', (evt) => {
        notifyPhp('events', {
            event: 'Native\\Nette\\Events\\Windows\\WindowHidden',
            payload: [id]
        });
    });
