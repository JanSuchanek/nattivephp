...
autoUpdater.addListener("checking-for-update", () => {
    notifyPhp("events", {
        event: `\\Native\\Nette\\Events\\AutoUpdater\\CheckingForUpdate`,
    });
});

autoUpdater.addListener("update-available", (event: UpdateInfo) => {
    notifyPhp("events", {
        event: `\\Native\\Nette\\Events\\AutoUpdater\\UpdateAvailable`,
        payload: {
...
autoUpdater.addListener("update-not-available", (event: UpdateInfo) => {
    notifyPhp("events", {
        event: `\\Native\\Nette\\Events\\AutoUpdater\\UpdateNotAvailable`,
        payload: {
            version: event.version,
            files: event.files,
            releaseDate: event.releaseDate,
...
autoUpdater.addListener("error", (error: Error) => {
    notifyPhp("events", {
        event: `\\Native\\Nette\\Events\\AutoUpdater\\Error`,
        payload: {
            name: error.name,
...
autoUpdater.addListener("download-progress", (progressInfo: ProgressInfo) => {
    notifyPhp("events", {
        event: `\\Native\\Nette\\Events\\AutoUpdater\\DownloadProgress`,
        payload: {
...
autoUpdater.addListener("update-downloaded", (event: UpdateDownloadedEvent) => {
    notifyPhp("events", {
        event: `\\Native\\Nette\\Events\\AutoUpdater\\UpdateDownloaded`,
        payload: {
...
autoUpdater.addListener("update-cancelled", (event: UpdateInfo) => {
    notifyPhp("events", {
        event: `\\Native\\Nette\\Events\\AutoUpdater\\UpdateCancelled`,
        payload: {
            version: event.version,
            files: event.files,
            releaseDate: event.releaseDate,
